    ...
    $popout = $(`
        <div id="moonlit_echoes_popout" class="draggable" style="display: none;">
            <div class="panelControlBar flex-container" id="moonlitEchoesPopoutHeader">
                <div class="fa-solid fa-moon" style="margin-right: 10px; color: #ffb6c1;"></div>
                <div class="title" style="color: #ff99a8; font-weight: bold; letter-spacing: 1px;">𜗿 Moonlit Echoes Theme 🎀</div>
                <div class="flex1"></div>
                <div class="fa-solid fa-grip drag-grabber hoverglow" style="color: #ffb6c1;"></div>
                <div class="fa-solid fa-circle-xmark hoverglow dragClose" style="color: #ff99a8; transition: all 0.3s ease;"></div>
            </div>
