...
export function createCustomSettingsUI(container, settings) {
    ...
    Object.keys(categories).forEach(category => {
        ...
        titleContainer.style.padding = '8px 0';
        titleContainer.style.borderBottom = '2px dashed rgba(255, 182, 193, 0.5)'; /* Frufru na divisão */
        titleContainer.style.color = '#ff99a8'; /* Título rosinha */
...
export function createSettingItem(container, setting, settings) {
    ...
    if (setting.type !== 'checkbox') {
        ...
        if (setting.description) {
            ...
            description.style.color = '#ffb6c1';
...
function createColorPicker(container, setting, settings) {
    ...
    colorPickerContainer.style.padding = '4px 0';
    ...
    colorPreview.style.borderRadius = '10px'; /* Quadrado arredondado fofo */
    colorPreview.style.border = '2px solid #ffb6c1'; /* Borda rosinha */
    colorPreview.style.background = currentValue;
    colorPreview.style.cursor = 'pointer';
    colorPreview.style.boxShadow = '0 2px 8px rgba(255, 182, 193, 0.5)'; /* Glow fofo */
    ...
    textInput.style.backgroundColor = 'rgba(255, 240, 245, 0.8)';
    textInput.style.border = '1px dashed #ffb6c1';
    textInput.style.borderRadius = '15px'; /* Nuvem */
    textInput.style.color = '#ff99a8';
    ...
    alphaSlider.style.backgroundColor = 'rgba(255, 182, 193, 0.4)'; /* Trilho rosa claro */
    ...
    function updateSliderThumbColor(hexColor) {
        const newThumbStyle = `
            #${alphaSlider.id}::-webkit-slider-thumb {
                ...
                box-shadow: 0 0 5px rgba(255, 153, 168, 0.6);
                cursor: pointer;
            }
...
function createTextareaInput(container, setting, settings) {
    ...
    /* CSS Coquette direto na caixa grande */
    textarea.style.backgroundColor = 'rgba(255, 240, 245, 0.8)';
    textarea.style.border = '2px dashed #ffb6c1';
    textarea.style.borderRadius = '15px';
    textarea.style.color = '#ff99a8';
...
function createCheckbox(container, setting, settings) {
    ...
    checkboxContainer.style.background = 'rgba(255, 255, 255, 0.6)';
    checkboxContainer.style.border = '1px dashed #ffb6c1';
   ...
   function updateInlineCssBlock(enabled) {
    ...
    if (description) {
        ...
        descriptionElement.style.color = '#ffb6c1';
