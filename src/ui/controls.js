    ...
    if (!sidebarStylesInjected) {
        const buttonStyles = `
            .moonlit-tip-container {
                margin: 10px 0;
                border: 2px dashed #ffb6c1; /* Bordinha fofa! */
                border-radius: 15px; /* Cantos de nuvem */
                overflow: hidden;
                font-size: 0.9em !important;
                background: rgba(255, 240, 245, 0.6); /* Vidro rosa */
            ...
            #moonlit_sidebar_button:hover {
                ...
                transform: scale(1.1); /* Dá um pulinho */
                color: #ff6b81;
            ...
            #moonlit_echoes_popout {
                ...
                padding-bottom: 15px;
                border: 0;
                border-top: 2px dashed #ffb6c1 !important; /* Divisão Coquette */
            ...
            #moonlit_echoes_content_container {
                ...
                .moonlit-tab-buttons {
                    ...
                    top: 0;
                    backdrop-filter: blur(12px);
                    background-color: rgba(255, 240, 245, 0.85); /* Fundo dos botões rosa */
                    z-index: 100;
                }
            ...
            #moonlit_echoes_popout .panelControlBar {
                ...
                font-weight: bold;
                color: #ff99a8;
                border-bottom: 2px dashed #ffb6c1; /* Linha tracejada */
            }
            ...
            #moonlit_echoes_popout .dragClose:hover {
                color: #ff99a8;
                transform: scale(1.1); /* Pulinho no X */
            }
        `;
...
function fixDrawerHeaderLayout(settingsKey) {
    ...
    styleElement.textContent = `
        ...
        #moonlit_settings_popout_button:hover {
            transform: scale(1.1);
        }
