...
function addExtensionMenuButton() {
    ...
    // Create button element with moon icon and theme name (Coquette style)
    let $button = $(`
    <div class="list-group-item flex-container flexGap5 interactable" title="Open Moonlit Echoes Theme Settings" data-i18n="[title]Open Moonlit Echoes Theme Settings" tabindex="0" style="border-radius: 15px; transition: all 0.3s ease;">
        <i class="fa-solid fa-moon" style="color: #ff99a8;"></i>
        <span style="color: #ffb6c1; font-weight: bold;">𝜗ৎ Moonlit Echoes ♡</span>
    </div>
    `);
...
function addThumbnailTip(container) {
    ...
    tipContainer.style.border = '2px dashed #ffb6c1';
    tipContainer.style.background = 'rgba(255, 240, 245, 0.6)';
    tipContainer.style.boxShadow = '0 4px 10px rgba(255, 182, 193, 0.2)';
    ...
    tipHeader.style.padding = '8px 10px';
    ...
    tipContent.innerHTML = `
        <div style="line-height: 1.4; color: #ff99a8;">
            <span data-i18n="Please refer to the">Please refer to the</span> <a href="https://github.com/RivelleDays/SillyTavern-MoonlitEchoesTheme" target="_blank" style="color: #ffb6c1; text-decoration: underline dashed #ffb6c1; font-weight: bold;">Moonlit Echoes Theme GitHub README 𖹭</a> <span data-i18n="and complete the necessary setup.">and complete the necessary setup.</span>
            </div>
        </div>
    `;
...
function addSlashCommandsTip(container) {
    ...
    const tipTitle = document.createElement('span');
    tipTitle.textContent = t`𜗿 Chat Style Slash Commands ᯓᡣ𐭩`;
    ...
    tipContent.innerHTML = `
    <div style="line-height: 1.5; color: #ff99a8;">
        <span style="font-weight:bold; color: #ffb6c1;" data-i18n="Moonlit Echoes Styles:">✿ Moonlit Echoes Styles:</span>
        <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px; list-style-type: '♡ ';">
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/echostyle</code> - <span data-i18n="Switch to Echo style">Switch to Echo style</span></li>
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/whisperstyle</code> - <span data-i18n="Switch to Whisper style">Switch to Whisper style</span></li>
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/hushstyle</code> - <span data-i18n="Switch to Hush style">Switch to Hush style</span></li>
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/ripplestyle</code> - <span data-i18n="Switch to Ripple style">Switch to Ripple style</span></li>
            <li><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/tidestyle</code> - <span data-i18n="Switch to Tide style">Switch to Tide style</span></li>
        </ul>

        <span style="font-weight:bold; color: #ffb6c1;" data-i18n="SillyTavern Safe Switch Commands:">✿ SillyTavern Safe Switch Commands:</span>
        <ul style="margin-top: 5px; margin-bottom: 10px; padding-left: 20px; list-style-type: '𖹭 ';">
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/moonlit-flat</code> - <span data-i18n="Switch to Flat style">Switch to Flat style</span></li>
            <li style="margin-bottom: 8px;"><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/moonlit-bubble</code> - <span data-i18n="Switch to Bubble style">Switch to Bubble style</span></li>
            <li><code style="background: rgba(255, 255, 255, 0.6); color: #ff99a8; border-radius: 10px; padding: 2px 6px; border: 1px solid #ffb6c1;">/moonlit-document</code> - <span data-i18n="Switch to Document style">Switch to Document style</span></li>
        </ul>
        ...
        <div style="margin-top: 8px; margin-bottom: 5px; text-align: center;">
            ...
            <button class="menu_button menu_button_icon inline-flex interactable" onclick="window.open('https://docs.sillytavern.app/usage/st-script/', '_blank')" tabindex="0" style="margin-left: 5px; font-size: 0.9em; background: rgba(255, 240, 245, 0.8); border: 2px solid #ffb6c1; border-radius: 15px; color: #ff99a8;">
                <i class="fa-solid fa-terminal"></i>
                <span data-i18n="STscript Reference">STscript Reference 𓇼</span>
            </button>
        </div>
    </div>
`;
...
function renderExtensionSettings() {
    ...
    extensionNameElement.textContent = `𝜗ৎ ${EXTENSION_NAME} ✿`;
    extensionNameElement.style.color = '#ff99a8';

    const inlineDrawerIcon = document.createElement('div');
    inlineDrawerIcon.classList.add('inline-drawer-icon', 'fa-solid', 'fa-circle-chevron-down', 'down');
    inlineDrawerIcon.style.color = '#ffb6c1';
    ...
    enabledCheckboxText.textContent = t`♡ Enable Moonlit Echoes Theme (Coquette) 𖹭`;
    enabledCheckboxText.style.color = '#ff99a8';
    enabledCheckboxText.style.fontWeight = 'bold';
    ...
    originalAvatarText.textContent = t`✿ Use original character avatars in chat messages 𓇼`;
    originalAvatarText.style.color = '#ff99a8';
...
function addThemeCreatorInfo(container) {
    ...
    creatorContainer.innerHTML = `
        <small id="moonlit-echoes-creator" style="color: #ff99a8; font-size: 0.9em;">
            <span>𜗿 Created with Heartfelt Passion by</span>
            <a href="https://github.com/RivelleDays" target="_blank" rel="noopener noreferrer" style="color: #ffb6c1; font-weight: bold; text-decoration: underline dashed #ff99a8;">Rivelle 𖹭</a><br>
...
versionContainer.innerHTML = `
    <small class="flex-container justifyCenter alignitemscenter" style="color: #ff99a8;">
        <span data-i18n="Moonlit Echoes Theme Version">ᯓᡣ𐭩 Moonlit Echoes Theme Version</span>
        <a id="moonlit-echoes-version"
            href="https://github.com/RivelleDays/SillyTavern-MoonlitEchoesTheme"
            target="_blank"
            rel="noopener noreferrer"
            style="margin-left: 5px; color: #ffb6c1; font-weight: bold; background: rgba(255, 240, 245, 0.8); border: 1px dashed #ff99a8; padding: 2px 8px; border-radius: 10px;">${THEME_VERSION} 𓇼</a>
    </small>
`;
